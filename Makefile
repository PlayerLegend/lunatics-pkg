...
src/window/path.o: src/range/def.h src/window/def.h src/window/path.h
...
src/window/string.o: src/window/string.h src/range/def.h src/window/def.h
src/window/string.o: src/window/alloc.h
src/window/vprintf.o: src/range/def.h src/window/def.h
...
src/window/printf.o: src/range/def.h src/window/def.h
src/window/path.o: src/range/def.h src/window/def.h
...
src/window/test/printf.test.o: src/window/string.h src/range/def.h
src/window/test/printf.test.o: src/window/def.h src/window/printf.h
...
src/window/string.o: src/range/def.h src/window/def.h
...
src/http/client.o: src/range/def.h src/window/def.h src/keyargs/keyargs.h
src/http/client.o: src/convert/source.h
src/http/http-cat.util.o: src/range/def.h src/window/def.h src/window/alloc.h
src/http/http-cat.util.o: src/keyargs/keyargs.h src/convert/source.h
...
src/http/client.o: src/window/string.h src/range/def.h src/range/string.h
src/http/client.o: src/window/def.h src/window/alloc.h src/keyargs/keyargs.h
...
src/table/table-int.o: src/window/string.h src/range/def.h src/table/table.h
src/table/table-string.o: src/window/string.h src/range/def.h
src/table/table-string.o: src/table/table.h
src/table/table.o: src/window/string.h src/range/def.h
...
src/tar/write.o: src/range/def.h src/window/def.h src/convert/sink.h
src/tar/write.o: src/convert/source.h src/keyargs/keyargs.h src/tar/common.h
src/tar/read.o: src/keyargs/keyargs.h src/range/def.h src/window/def.h
...
src/tar/read.o: src/window/string.h src/range/def.h src/window/def.h
src/tar/read.o: src/window/alloc.h src/window/printf.h src/convert/source.h
src/tar/read.o: src/keyargs/keyargs.h src/tar/common.h src/tar/read.h
src/tar/read.o: src/log/log.h src/tar/internal/spec.h
src/tar/write.o: src/window/string.h src/range/def.h src/window/def.h
src/tar/write.o: src/window/alloc.h src/keyargs/keyargs.h src/convert/sink.h
...
src/pkg/install.o: src/window/string.h src/range/def.h src/window/def.h
src/pkg/install.o: src/window/path.h src/keyargs/keyargs.h
...
src/pkg/install.o: src/range/string.h src/window/alloc.h src/window/string.h
...
src/pkg/root.o: src/keyargs/keyargs.h
...
src/pkg/update.o: src/immutable/immutable.h src/keyargs/keyargs.h
src/pkg/pack.util.o: src/window/string.h src/keyargs/keyargs.h
src/pkg/pack.util.o: src/range/def.h src/convert/sink.h src/convert/fd/sink.h
src/pkg/pack.util.o: src/pkg/pack.h src/log/log.h
src/pkg/pack.o: src/keyargs/keyargs.h src/range/def.h src/window/def.h
src/pkg/pack.o: src/convert/source.h src/convert/sink.h
src/pkg/manifest.o: src/window/string.h src/keyargs/keyargs.h
src/pkg/root.o: src/window/string.h src/keyargs/keyargs.h src/pkg/root.h
src/pkg/root.o: src/range/def.h src/range/string.h src/window/def.h
...
src/pkg/install.util.o: src/keyargs/keyargs.h src/range/def.h
src/pkg/install.util.o: src/window/def.h src/window/alloc.h
src/pkg/install.util.o: src/convert/source.h src/convert/fd/source.h
src/pkg/install.util.o: src/pkg/root.h src/pkg/install.h src/log/log.h
src/pkg/install.o: src/range/def.h src/window/def.h src/convert/source.h
src/pkg/install.o: src/keyargs/keyargs.h src/pkg/root.h
src/pkg/pack.o: src/window/string.h src/keyargs/keyargs.h src/pkg/root.h
src/pkg/pack.o: src/range/def.h src/range/string.h src/window/def.h
...
src/convert/getline.o: src/keyargs/keyargs.h src/convert/source.h
...
src/convert/duplex.o: src/range/def.h src/window/def.h src/convert/sink.h
...
src/network/network.o: src/keyargs/keyargs.h src/range/def.h src/window/def.h
src/network/network.o: src/log/log.h src/window/alloc.h src/network/network.h
src/network/test/tcp/server.test.o: ../../../keyargs/keyargs.h
src/network/test/tcp/server.test.o: ../../../range/def.h src/window/def.h
src/network/test/tcp/server.test.o: src/window/alloc.h src/network/network.h
...
src/lang/tokenizer/test/tokenizer.test.o: ../../../range/def.h
src/lang/tokenizer/test/tokenizer.test.o: src/window/def.h src/window/alloc.h
src/lang/tokenizer/test/tokenizer.test.o: src/convert/source.h
src/lang/tokenizer/test/tokenizer.test.o: ../../../keyargs/keyargs.h
...
src/lang/tree/test/tree.test.o: ../../../range/def.h src/log/log.h
src/lang/tree/test/tree.test.o: src/window/def.h src/window/alloc.h
src/lang/tree/test/tree.test.o: ../../../keyargs/keyargs.h
src/lang/tree/test/tree.test.o: src/convert/source.h src/convert/fd/source.h
...
src/immutable/immutable.o: src/window/string.h src/range/def.h
...
src/immutable/immutable.o: src/range/def.h
